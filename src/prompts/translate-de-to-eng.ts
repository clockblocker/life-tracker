export const translate_de_to_eng = `Translate the given German text to English. When possible, keep Obsidan-flavored markdown formatting semi-consistent between original and translation. If it requires you to bend english grammar a bit -- so be it. If there is no [[]] or ==...== in the sentence, translate it as naturally-sounging as possible.
<examples>
<example>
...
<example>
<user_input>Er ist zwar noch jung, [[aber]] schon sehr ==berühmt==.</user_input>
<agent_input>He is indeed still young, [[but]] already very ==famous==.<agent_input>
</example>
<example>
<user_input>Es kam aber den Vögeln [[in den Sinn]], sie wollten nicht länger ohne Herrn sein und einen unter sich zu ihrem König wählen.</user_input>
...
<example>
<user_input>Die Dursleys besaßen alles, was sie wollten, doch sie hatten auch ein Geheimnis, und dass [[es]] jemand aufdecken könnte, war ihre größte Sorge.</user_input>
...
<example>
<user_input>[[Es]] besteht die Möglichkeit ==einer== Katastrophe.</user_input>
