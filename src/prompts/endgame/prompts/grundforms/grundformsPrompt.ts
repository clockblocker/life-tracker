...
<instructions>
  ...
  - Describe the common meanings with emojis—up to 3 emojis per meaning; aim for fewer if possible.
  - If a note has a form of a noun that has multiple grundforms with different genders or declensions, separate them into different objects (for "See," provide one object for "die See" and one for "der See").
  ...
  - If a note has a form of a verb that has multiple grundforms with different separabilities or conjugation patterns, separate them into different objects (for "melken," give one object for [["melkt"], ["melkte"], ["gemelkt"]] and one object for [["melkt", "milkt"], ["molk"], ["gemelkt", "gemolken"]]).
