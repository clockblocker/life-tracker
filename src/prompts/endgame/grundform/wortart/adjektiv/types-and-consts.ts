import { Genus, Kasus, NomenDeklination, Numerus, Vergleichsgrad } from "prompts/endgame/zod/types";
import { z } from "zod";
...
export const caseDeclensionKeys = Object.keys(CaseDeclensionSchema.shape) as CaseDeclensionKeys[];
...
export const declensionKeys = Object.keys(DeclensionsSchema.shape) as DeclensionsKeys[];
...
export const allDeclensionsKeys = Object.keys(AllDeclensionsSchema.shape) as AllDeclensionsKeys[];
...
export type AllDeclensionsFromGradKeys = keyof z.infer<typeof AllDeclensionsFromGradSchema>;
export const allDeclensionsFromGradKeys = Object.keys(AllDeclensionsFromGradSchema.shape) as AllDeclensionsFromGradKeys[];
