import { z } from "zod";
import { Grundform, GrundformsWithMatchStatus, MatchStatus } from "../../zod/types";
...
export const formatMatchStatus = ({ matchStatus }: GrundformsWithMatchStatus) => {
    const repr = reprFromMatchStatus[matchStatus];
