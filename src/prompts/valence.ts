...
const hoffen_valenz = "###### [[hoffen]] `auf` jN\n" +  
"– `Worauf` [[hoffst]] du?\n" +  
"– `Auf` gutes Wetter.\n\n" +  
"– `Auf` wen [[hoffen]] sie?\n" +  
"– `Auf` ihren Trainer.\n\n" +  
...
const vorstellen_valenz = "###### [[stellen]] jN jM [[vor]]\n" +
...
const aufpassen_valenz = "###### [[aufpassen]] `auf` jN\n" + 
"– `Worauf` [[passt]] du [[auf]]?\n" +  
"– `Auf` den Verkehr.\n\n" +  
...
const gewöhnen_valenz = "###### [[gewöhnen]] *[[sich]]* `an` jN\n" +  
...
const darstellen_valenz = "###### [[darstellen]] jN\n" +    
